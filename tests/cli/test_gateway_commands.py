...
from pawbot.cli.gateway import _resolved_config_selector, create_gateway_app
...
from pawbot.gateway.service import GatewayServiceOptions, GatewayServiceResult
...
class FakeServiceInstaller:
    ...
    def install(self, options: GatewayServiceOptions, *, dry_run: bool) -> GatewayServiceResult:
        ...
        return GatewayServiceResult(
            ...
            "systemd",
            self.tmp_path / "pawbot-gateway.service",
...
def test_gateway_restart_does_not_create_a_persistent_gateway(tmp_path):
    ...
    assert "pawbot gateway --background" in result.stdout
