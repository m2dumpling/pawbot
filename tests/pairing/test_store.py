...
from pawbot.pairing import __all__ as pairing_all
from pawbot.pairing import store


def test_all_exports_are_importable():
    """Every name in __all__ must actually be importable from pawbot.pairing."""
    import pawbot.pairing as pkg
