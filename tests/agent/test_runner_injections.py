...
async def test_drain_injections_passes_limit_to_callback_when_supported():
    ...
    from pawbot.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner
    from pawbot.bus.events import InboundMessage
...
async def test_injection_cycles_capped_at_max():
    ...
    from pawbot.agent.runner import _MAX_INJECTION_CYCLES, AgentRunner
    from pawbot.bus.events import InboundMessage
...
async def test_cron_turn_deferred_while_session_active(tmp_path):
    ...
    from pawbot.bus.events import InboundMessage
    from pawbot.cron.session_turns import (
...
async def test_local_trigger_turn_deferred_while_session_active(tmp_path):
    ...
    from pawbot.bus.events import InboundMessage
    from pawbot.triggers.local_session_turns import LOCAL_TRIGGER_META
...
async def test_submitted_cron_turn_reports_pending_until_completed(tmp_path):
    ...
    from pawbot.cron.session_turns import CRON_TRIGGER_META
...
async def test_local_trigger_turn_cancellation_reports_agent_failure(tmp_path):
    ...
    from pawbot.agent.automation_turns import AutomationTurnError
    from pawbot.bus.events import InboundMessage
    from pawbot.triggers.local_session_turns import LOCAL_TRIGGER_META
...
async def test_pending_queue_preserves_overflow_for_next_injection_cycle(tmp_path):
    ...
    from pawbot.agent.loop import AgentLoop
    from pawbot.agent.runner import _MAX_INJECTIONS_PER_TURN
    from pawbot.bus.events import InboundMessage
    from pawbot.bus.queue import MessageBus
...
async def test_pending_queue_overflow_keeps_websocket_followup_durable(tmp_path):
    ...
    from pawbot.session.recovery import pending_followups
...
async def test_drain_injections_on_empty_final_response():
    ...
    from pawbot.agent.runner import _MAX_EMPTY_RETRIES, AgentRunner
    from pawbot.bus.events import InboundMessage
