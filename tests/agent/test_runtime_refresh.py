...
from pawbot.bus.runtime_events import RuntimeModelChanged
...
from pawbot.providers.factory import ProviderSnapshot, load_provider_snapshot
from pawbot.session.model_selection import (
    SESSION_MODEL_PRESET_METADATA_KEY,
    model_preset_from_metadata,
)
from pawbot.webui.settings_api import update_agent_settings
...
def test_provider_snapshot_missing_env_reports_explicit_config_path(
    ...
    name = "PAWBOT_TEST_REFRESH_MISSING_KEY"
