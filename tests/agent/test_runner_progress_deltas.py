...
from pawbot.agent.hooks import FileEditActivityHook
from pawbot.agent.progress_hook import AgentProgressHook
from pawbot.agent.runner import AgentRunner
from pawbot.agent.tools.filesystem import EditFileTool, WriteFileTool
...
async def test_runner_routes_hosted_tool_events_to_structured_progress():
    ...
    assert progress_text == ['search X "pawbot oauth"', ""]
