...
This protects the persisted-turn regression contract.
"""
...
from pawbot.session.recovery import RUNTIME_CHECKPOINT_KEY
...
def _make_loop(tmp_path: Path) -> AgentLoop:
    ...
    with patch("pawbot.agent.loop.ContextBuilder"), \
         ...
         patch("pawbot.agent.loop.SubagentManager") as mock_subagent_manager:
