...
from pawbot.agent.tools.cli_apps import CliAppsTool
from pawbot.agent.tools.context import RequestContext, ToolContext, request_context
from pawbot.agent.tools.filesystem import ReadFileTool, WriteFileTool
from pawbot.agent.tools.image_generation import ImageGenerationError, ImageGenerationTool
from pawbot.agent.tools.message import MessageTool
from pawbot.agent.tools.search import GrepTool
from pawbot.agent.tools.shell import ExecTool
from pawbot.agent.tools.spawn import SpawnTool
from pawbot.apps.cli.service import CliAppManager, CliAppsRuntimeConfig
from pawbot.config.schema import ImageGenerationToolConfig, ProviderConfig, ToolsConfig
...
async def test_cli_app_scope_controls_working_dir(
    ...
    monkeypatch.setattr("pawbot.apps.cli.service.get_runtime_subdir", lambda _name: data_dir)
    monkeypatch.setattr(
