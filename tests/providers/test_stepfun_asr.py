...
from pawbot.providers.transcription import StepFunTranscriptionProvider
...
def test_stepfun_in_registry() -> None:
    ...
    assert spec.adapter == "pawbot.providers.transcription:StepFunTranscriptionProvider"
