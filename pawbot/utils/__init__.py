...
from pawbot.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "pawbot.webui.thread_disk",
    "webui_transcript": "pawbot.webui.transcript",
    "webui_turn_helpers": "pawbot.session.webui_turns",
}
