"""On-demand version checker for pawbot-ai releases.
...
_PYPI_URL = "https://pypi.org/pypi/pawbot-ai/json"
...
def check_for_update() -> dict[str, Any] | None:
    ...
    try:
        ...
        logger.debug("PyPI returned an invalid pawbot version: %r", latest)
        return None
    return {
