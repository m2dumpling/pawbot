...
from pawbot.config.paths import get_webui_dir
from pawbot.runtime_context import public_history_message
from pawbot.session.automation_turns import is_automation_kind
...
def replay_transcript_to_ui_messages(
    ...
    *,
    ...
    Mirrors the core fold in ``usePawbotStream.ts`` (delta, reasoning,
