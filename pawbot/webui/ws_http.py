...
from pawbot.command.builtin import builtin_command_palette
from pawbot.cron.session_turns import is_bound_cron_job
from pawbot.cron.types import CronJob, CronSchedule
from pawbot.security.workspace_access import WorkspaceScope
from pawbot.session.manager import SessionManager
from pawbot.session.recovery import RecoveryActionError
from pawbot.session.session_handles import (
    SessionHandleResolver,
)
from pawbot.triggers.local_types import LocalTrigger
from pawbot.webui.file_preview import (
    WebUIFilePreviewError,
    file_preview_availability_payload,
    file_preview_payload,
)
from pawbot.webui.gateway_tokens import GatewayTokenStore, token_response_payload
...
from pawbot.webui.http_utils import is_loopback_host as _is_loopback_host
from pawbot.webui.http_utils import (
...
from pawbot.webui.ingress_policy import WebUIIngressPolicy
from pawbot.webui.media_gateway import WebUIMediaGateway
from pawbot.webui.native_folder_picker import (
    NativeFolderPickerError,
    native_folder_picker_available,
    pick_native_folder,
)
from pawbot.webui.session_automations import (
    all_automations_payload,
    serialize_automation_jobs,
    session_automation_jobs,
    session_automations_payload,
)
from pawbot.webui.session_context import session_context_payload
from pawbot.webui.session_identity import is_webui_session_key
from pawbot.webui.session_list_index import (
    WEBUI_SESSION_INDEX_INTERNAL_FIELDS,
    indexed_workspace_scope,
    list_webui_sessions,
)
from pawbot.webui.sidebar_state import (
    read_webui_sidebar_state,
    write_webui_sidebar_state,
)
from pawbot.webui.skills_api import (
...
from pawbot.webui.skills_marketplace import (
...
from pawbot.webui.thread_disk import delete_webui_thread
from pawbot.webui.transcript import build_webui_thread_response
from pawbot.webui.workspaces import WebUIWorkspaceController
...
_WEBUI_MUTATION_PATHS = {
    ...
    "settings.feature.enable": "/api/settings/pawbot-features/enable",
    "settings.feature.disable": "/api/settings/pawbot-features/disable",
    ...
    "blackbox.status": "/api/blackbox/status",
...
class GatewayHTTPHandler:
    ...
    def __init__(
        ...
        *,
        ...
        from pawbot.webui.settings_api import runtime_capabilities as _rc
    ...
    def check_api_token(self, request: WsRequest) -> bool:
        if getattr(request, "_pawbot_trusted_proxy_authenticated", False):
            return True
    ...
    async def dispatch(self, connection: Any, request: WsRequest) -> Any | None:
        ...
        setattr(
            request,
            "_pawbot_trusted_proxy_authenticated",
    ...
    async def dispatch_webui_mutation(
        ...
        setattr(request, "_pawbot_trusted_proxy_authenticated", True)
    ...
    async def _dispatch_resolved(
        ...
        # Blackbox (Record & Replay) + token-governance routes
        response = await self._dispatch_blackbox_routes(request, got)
        if response is not None:
            return response
    ...
    def _sessions_list_payload(self) -> dict[str, Any]:
        ...
        from pawbot.session.webui_turns import websocket_turn_wall_started_at
    ...
    def _handle_webui_thread_get(self, request: WsRequest, key: str) -> Response:
        ...
        from pawbot.session.webui_turns import (
            websocket_turn_id,
