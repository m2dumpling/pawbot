...
from pawbot.session.summary import session_summary_from_metadata
from pawbot.utils.gitstore import GitStore
...
from pawbot.utils.workspace_prompts import (
...
class MemoryStore:
    ...
    def build_dream_tools(self) -> ToolRegistry:
        ...
        from pawbot.agent.skills import BUILTIN_SKILLS_DIR
        from pawbot.agent.tools.apply_patch import ApplyPatchTool
        from pawbot.agent.tools.file_state import FileStates
        from pawbot.agent.tools.filesystem import EditFileTool, ReadFileTool, WriteFileTool
        from pawbot.agent.tools.registry import ToolRegistry
