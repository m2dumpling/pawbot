...
from pawbot.agent.tools.context import ToolContext, current_request_context
from pawbot.agent.tools.path_utils import resolve_workspace_path
from pawbot.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
from pawbot.bus.events import OutboundMessage
from pawbot.config.paths import get_workspace_path
...
class MessageTool(Tool):
    ...
    def compactable(self) -> bool:
        """Keep delivery acknowledgements intact during context compaction."""
        return False
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from pawbot.utils.helpers import strip_think
