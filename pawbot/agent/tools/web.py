...
from pawbot.utils.helpers import build_image_content_blocks
...
_VOLCENGINE_TRAFFIC_TAG = "pawbot"
...
def _resolve_url_safe(url: str) -> tuple[bool, str, tuple[str, ...]]:
    ...
    from pawbot.security.network import resolve_url_target
...
def _fetch_client_kwargs(proxy: str | None, timeout: float) -> dict[str, Any]:
    from pawbot.security.network import httpx_env_proxy_mounts
...
def _unsafe_url_request_error(exc: BaseException) -> str | None:
    from pawbot.security.network import UnsafeURLRequestError
    ...
    async def _search_olostep(self, query: str, n: int) -> str:
        try:
            ...
            return ToolResult.error(
                ...
                "Run `pawbot plugins enable olostep`."
            )
