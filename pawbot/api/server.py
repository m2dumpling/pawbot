"""OpenAI-compatible HTTP API server for a fixed pawbot session.
...
from pawbot.utils.media_decode import (
    MAX_FILE_SIZE,
)
from pawbot.utils.media_decode import (
...
async def handle_chat_completions(request: web.Request) -> web.Response | web.StreamResponse:
    ...
    model_name: str = _app_value(request.app, _MODEL_NAME_KEY, "model_name", "pawbot")
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = _app_value(request.app, _MODEL_NAME_KEY, "model_name", "pawbot")
    return web.json_response(
        {
            "object": "list",
            "data": [
