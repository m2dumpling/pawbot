...
def provider_login(
    ...
    if config:
        from pawbot.config.loader import set_config_path
...
def _login_xai_grok() -> None:
    ...
    from pawbot.config.loader import load_config, resolve_config_env_vars
    from pawbot.providers.xai_oauth import get_xai_oauth_token, login_xai_oauth
...
def _logout_xai_grok() -> None:
    """Clear local xAI OAuth credentials for this pawbot instance."""
    from pawbot.providers.xai_oauth import get_xai_oauth_storage_path, logout_xai_oauth
...
def _login_github_copilot() -> None:
    try:
        from pawbot.providers.github_copilot_provider import login_github_copilot
