"""High-level programmatic interface to pawbot."""
...
from pawbot.sdk.clients import MemoryClient, RuntimeClient, SessionClient
from pawbot.sdk.runtime import (
    build_process_direct_kwargs,
    ensure_single_model_selector,
)
from pawbot.sdk.streaming import RunStream, SDKStreamEmitter, SDKStreamingHook
from pawbot.sdk.types import (
...
class Pawbot:
    """Programmatic facade for running the pawbot agent.
    ...
    def from_config(
        ...
        *,
        ...
        """Create a Pawbot instance from a config file.
        ...
        *,
        ...
        Args:
            ...
            attributes: Optional caller-owned request data exposed to context
                ...
                from pawbot's trusted internal message metadata.
    ...
    async def __aenter__(self) -> Pawbot:
        return self
