...
from pawbot.providers.registry import ProviderSpec, create_dynamic_spec, find_by_name
...
def _make_provider_core(
    ...
    *,
    ...
    if backend == "openai_codex":
        ...
        from pawbot.providers.xai_grok_provider import XAIGrokProvider
        ...
        from pawbot.providers.azure_openai_provider import AzureOpenAIProvider
        ...
        from pawbot.providers.anthropic_provider import AnthropicProvider
        ...
        from pawbot.providers.bedrock_provider import BedrockProvider
