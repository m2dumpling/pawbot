...
from pawbot.providers.openai_responses import (
...
def _openai_compat_timeout_s() -> float:
    ...
    return _float_env("PAWBOT_OPENAI_COMPAT_TIMEOUT_S", _OPENAI_COMPAT_REQUEST_TIMEOUT_S)
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply Pawbot attribution headers to OpenRouter requests by default."""
...
class OpenAICompatProvider(LLMProvider):
    ...
    def _gemini_thought_signature(tool_call: dict[str, Any]) -> str | None:
        ...
        pawbot preserves it through the parse -> serialize round-trip so
    ...
    def _build_kwargs(
        ...
        # otherwise lets extra_body.tools replace pawbot's generated functions.
        if self._extra_body:
