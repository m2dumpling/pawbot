...
from pawbot.security.network import validate_resolved_url, validate_url_target
...
class PawbotDingTalkHandler(_CallbackHandlerBase):
    """
    ...
    async def start(self) -> None:
        ...
        try:
            if not DINGTALK_AVAILABLE:
                self.logger.error(
                    "Stream SDK not installed. Run: pawbot plugins enable dingtalk"
                )
                return
