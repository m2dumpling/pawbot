...
import pawbot.channels.whatsapp.runtime as whatsapp_module
from pawbot.bus.events import OutboundMessage
from pawbot.bus.queue import MessageBus
from pawbot.channels.whatsapp.runtime import (
    WhatsAppChannel,
...
async def test_unauthorized_dm_uses_base_pairing_flow(monkeypatch) -> None:
    _patch_neonize_api(monkeypatch)
    monkeypatch.setattr("pawbot.channels.base.generate_code", lambda _ch, _sid: "ABCD-EFGH")
