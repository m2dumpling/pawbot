...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pawbot plugins enable matrix"
    ) from e
...
from pawbot.config.paths import get_data_dir, get_media_dir
...
_MXC_IMAGE_PLACEHOLDER_PREFIX = "https://pawbot.invalid/matrix-mxc/"
