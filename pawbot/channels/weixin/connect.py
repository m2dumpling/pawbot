...
if TYPE_CHECKING:
    from pawbot.channels.weixin.runtime import WeixinChannel
...
class WeixinConnectStore:
    ...
    async def poll(self, session_id: str, *, verify_code: str = "") -> dict[str, Any]:
        ...
        from pawbot.channels.weixin.runtime import MAX_QR_REFRESH_COUNT
        ...
        if status == "binded_redirect":
            ...
            return {
                "session_id": session_id,
                "status": "succeeded",
                "message": "WeChat is already connected to this pawbot instance.",
            }
