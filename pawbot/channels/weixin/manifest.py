...
from pawbot.channels._manifest import field, required
...
from pawbot.channels.weixin.state import local_state_present
from pawbot.channels.weixin.validation import validate
