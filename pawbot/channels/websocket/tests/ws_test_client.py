"""Lightweight WebSocket test client for integration testing the pawbot WebSocket channel.

Provides an async ``WsTestClient`` class and token-issuance helpers that
integration tests can import and use directly::

    from pawbot.channels.websocket.tests.ws_test_client import WsTestClient
...
from pawbot.webui.http_utils import http_response
