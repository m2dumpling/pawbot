...
# python-telegram-bot exposes a six-parameter Application generic. Pawbot
...
class TelegramChannel(BaseChannel):
    ...
    def _normalize_telegram_command(content: str) -> str:
        """Map Telegram-safe command aliases back to canonical pawbot commands."""
    ...
    def _queue_key_for_message(message: Message) -> str:
        """Return the final pawbot session key used for ordered Telegram ingress."""
