...
from pawbot.channels.connect import ChannelConnectError, QueryParams, query_first
from pawbot.channels.feishu import runtime as feishu
from pawbot.channels.feishu.instances import DEFAULT_INSTANCE_ID, validate_instance_id
...
def _default_instance_name(instance_id: str) -> str:
    return "pawbot" if instance_id == DEFAULT_INSTANCE_ID else f"pawbot {instance_id}"
