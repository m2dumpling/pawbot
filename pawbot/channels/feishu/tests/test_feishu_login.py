...
from pawbot.channels.feishu.runtime import FeishuChannel
from pawbot.config import loader
from pawbot.config.schema import Config
from pawbot.pairing import store as pairing_store
...
def test_save_registration_result_reuses_existing_app_instance(monkeypatch, tmp_path):
    ...
    assert instances[0]["name"] == "pawbot"
