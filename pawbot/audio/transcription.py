...
This module owns pawbot's transcription behavior: config resolution,
...
HTTP details; those live in ``pawbot.providers.transcription``.
"""
...
from pawbot.config.loader import resolve_env_refs
from pawbot.config.paths import get_media_dir
from pawbot.config.schema import Config, ProviderConfig
from pawbot.providers.registry import find_by_name
from pawbot.utils.media_decode import FileSizeExceeded, save_base64_data_url
