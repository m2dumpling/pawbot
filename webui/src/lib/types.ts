...
export interface PawbotFeatureInfo {
  name: string;
  display_name: string;
  capabilities?: string[];
...
export interface PawbotChannelInstanceInfo {
  id: string;
  name: string;
  display_name?: string;
  avatar_url?: string;
...
export interface PawbotFeaturesPayload {
  features: PawbotFeatureInfo[];
...
export interface ChannelConnectPayload {
  ...
  app_id?: string;
  account?: string;
  pawbot_features?: PawbotFeaturesPayload;
}
