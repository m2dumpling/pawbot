...
const SETTINGS_NAV_ITEMS: Array<{ key: SettingsSectionKey; icon: LucideIcon; fallback: string }> = [
  ...
  { key: "personalization", icon: UserRound, fallback: "Personalization" },
...
export function standaloneSectionTitle(section: SettingsSectionKey): string {
  if (section === "apps") return "Toolbox";
  if (section === "automations") return "Scheduled tasks";
  if (section === "skills") return "Prompt packs";
