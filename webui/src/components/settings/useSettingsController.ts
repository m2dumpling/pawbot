...
export function useSettingsController({
  ...
  const {
    ...
    mcpOAuthPopupBlocked, mcpPresetAction, mcpPresets, mcpPresetsLoading, pawbotFeatureAction,
    pawbotFeatureConfirm, pawbotFeatures, pawbotFeaturesError, pawbotFeaturesLoading,
    ...
    setPawbotFeatureConfirm, setPawbotFeatures,
    setPawbotFeaturesError,
  } = systemState;
  const featureCatalog = pawbotFeatures?.features ?? [];
