...
export function useSystemSettingsState() {
  ...
  const [pawbotFeatures, setPawbotFeatures] = useState<PawbotFeaturesPayload | null>(null);
  ...
  const [pawbotFeaturesLoading, setPawbotFeaturesLoading] = useState(true);
  ...
  const [pawbotFeatureAction, setPawbotFeatureAction] = useState<string | null>(null);
  const [pawbotFeatureConfirm, setPawbotFeatureConfirm] = useState<PawbotFeatureInfo | null>(null);
  ...
  const [pawbotFeaturesError, setPawbotFeaturesError] = useState<string | null>(null);
