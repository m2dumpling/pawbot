  ...
  return (
    <div {...containerProps} ref={containerRef}>
      ...
      <div
        ...
        aria-hidden="true"
        className="pointer-events-none absolute left-0 top-0 z-0 !mt-0 rounded-[0.7rem] border border-primary/15 bg-primary/[0.07] opacity-0 shadow-[inset_3px_0_0_hsl(var(--primary)/0.7)] transition-[transform,width,height,opacity] duration-300 ease-out will-change-transform motion-reduce:transition-none dark:bg-primary/[0.16]"
      />
    </div>
  );
}
