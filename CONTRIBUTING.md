# Contributing to pawbot

Thank you for being here.

pawbot is built with a simple belief: good tools should feel calm, clear, and humane.
...
Use the remote configured for your checkout if it is not named `origin`.
...
We care about more than passing lint. We want pawbot to stay small, calm, and readable.
...
For questions or proposals, use the issue tracker and pull-request workflow of
the repository where pawbot is published. Keep reports focused and include the
reproduction command, platform, provider type, and relevant sanitized logs.
